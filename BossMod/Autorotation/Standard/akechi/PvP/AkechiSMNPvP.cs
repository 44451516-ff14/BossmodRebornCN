...
public sealed class AkechiSMNPvP(RotationModuleManager manager, Actor player) : AkechiTools<AID, TraitID>(manager, player)
{
    ...
    {
        var res = new RotationModuleDefinition("Akechi SMN (PvP)", "PvP 循环模块", "PvP", "Akechi", RotationModuleQuality.Basic, BitMask.Build((int)Class.SMN), 100, 30, PvP: PvPCompatibility.PvPOnly);
