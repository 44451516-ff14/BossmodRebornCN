...
public sealed class AkechiMCHPvP(RotationModuleManager manager, Actor player) : AkechiTools<AID, TraitID>(manager, player)
{
    ...
    {
        var res = new RotationModuleDefinition("Akechi MCH (PvP)", "PvP 循环模块", "PvP", "Akechi", RotationModuleQuality.Basic, BitMask.Build((int)Class.MCH), 100, 30, PvP: PvPCompatibility.PvPOnly);
